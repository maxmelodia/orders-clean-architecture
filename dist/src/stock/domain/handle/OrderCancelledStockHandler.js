...
class OrderCancelledStockHandler {
    ...
    notify(orderCancelled) {
        return __awaiter(this, void 0, void 0, function* () {
            for (const orderItem of orderCancelled.items) {
                const stockEntry = new StockEntry_1.default(orderItem.idItem, "in", orderItem.quantity);
                yield this.stockRepository.save(stockEntry);
            }
        });
    }
}
exports.default = OrderCancelledStockHandler;
